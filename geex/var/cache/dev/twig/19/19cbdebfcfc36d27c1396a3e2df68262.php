...
\t\t<div class=\"geex-content__modal__form\">
        ...
        <form class=\"geex-content__modal__form__wrapper\" method=\"post\">
          <div class=\"geex-content__modal__form__item\">
            <input type=\"text\" name=\"tache[nom]\" id=\"tache_nom\" class=\"geex-content__modal__form__input\" placeholder=\"Nom de la tâche\" required />
          </div>

          <div class=\"geex-content__modal__form__item\">
            <textarea name=\"tache[description]\" id=\"tache_description\" class=\"geex-content__modal__form__input geex-content__modal__form__input--textarea\" placeholder=\"Description\"></textarea>
          </div>

          <div class=\"geex-content__modal__form__item\">
            <select name=\"tache[statut]\" id=\"tache_statut\" class=\"geex-content__modal__form__input\">
          ...
          <div class=\"geex-content__modal__form__item\">
            <input type=\"datetime-local\" name=\"tache[dateLimite]\" id=\"tache_dateLimite\" class=\"geex-content__modal__form__input\" placeholder=\"Date limite\" />
          </div>

          <div class=\"geex-content__modal__form__item\">
            <h4 class=\"geex-content__modal__form__item__title\">Priorité</h4>
            <div class=\"geex-content__modal__form__item__single\">
              <input type=\"radio\" id=\"priorite_high\" name=\"tache[priorite]\" value=\"High\">
              <label for=\"priorite_high\">Haute</label>
            </div>
            <div class=\"geex-content__modal__form__item__single\">
              <input type=\"radio\" id=\"priorite_medium\" name=\"tache[priorite]\" value=\"Medium\">
              <label for=\"priorite_medium\">Moyenne</label>
            </div>
            <div class=\"geex-content__modal__form__item__single\">
              <input type=\"radio\" id=\"priorite_low\" name=\"tache[priorite]\" value=\"Low\">
              <label for=\"priorite_low\">Basse</label>
            </div>
          </div>

          <div class=\"geex-content__modal__form__item\">
            <input type=\"text\" name=\"tache[userAssocie]\" id=\"tache_userAssocie\" class=\"geex-content__modal__form__input\" placeholder=\"Utilisateur associé\" />
          </div>

          <div class=\"geex-content__modal__form__item\">
            <input type=\"number\" name=\"tache[fournisseurId]\" id=\"tache_fournisseurId\" class=\"geex-content__modal__form__input\" placeholder=\"ID du fournisseur\" />
          </div>
          ...
          <div class=\"geex-content__modal__form__item\">
            ...
            <div class=\"geex-content__form__single__box\">
              ...
              <input type=\"number\" min=\"0\" max=\"10000\" step=\"10\" value=\"0\" id=\"tache_budget_text\" class=\"form-control\" />
            </div>
          </div>
...
<script>
  const budgetSlider = document.getElementById(\"tache_budget\");
  const budgetText = document.getElementById(\"tache_budget_text\");

  budgetSlider.addEventListener(\"input\", () => {
    budgetText.value = budgetSlider.value;
  });

  budgetText.addEventListener(\"input\", () => {
    const val = parseInt(budgetText.value);
...
{% endblock %}
", "app/todo.html.twig", "C:\\Users\\BestPc\\Documents\\ProjetWeb\\geex\\templates\\app\\todo.html.twig");
    }
}
