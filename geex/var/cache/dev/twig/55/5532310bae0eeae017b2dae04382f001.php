...
class __TwigTemplate_a0b8920d08aea4ebe3a93613b2802ca1 extends Template
{
                    ...
                    yield "                                    <div class=\"card-block\">
                                        <div class=\"row\">
                                            <div class=\"col\">
                                                ...
                                                <pre class=\"prewrap\">";
                    // line 122
                    yield (((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["message"] ?? null), "getNotification", [], "method", false, true, false, 122), "getContent", [], "method", true, true, false, 122) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 122, $this->source); })()), "getNotification", [], "method", false, false, false, 122), "getContent", [], "method", false, false, false, 122)))) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 122, $this->source); })()), "getNotification", [], "method", false, false, false, 122), "getContent", [], "method", false, false, false, 122), "html", null, true)) : ("(empty)"));
                    yield "</pre>
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/notifier.html.twig", "C:\\Users\\BestPc\\Documents\\ProjetWeb\\geex\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\notifier.html.twig");
    }
}
