...
public class Utilisateur {
    ...
    public Utilisateur(int utilisateurId, String nom,String email,String motDePasse,Role role,String etat, int note_organisateur, String entreprise, List<Evenement> evenements) {
        this.utilisateurId = utilisateurId;
        this.nom = nom;
        this.email = email;
        this.motDePasse = motDePasse;
